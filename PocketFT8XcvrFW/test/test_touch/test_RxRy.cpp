 ...
 *
 * This basic test calculates the values of the touchscreen planes' X-Resistance (Rx)
 ...
 *          value of Rx or Ry.
 *
 *          The tolerance of the 510 Ohm resistors on the V2 boards is 5%.  You may
 *          find notable variances of Vx and Vy (applied bias voltages) as a result.
 *
