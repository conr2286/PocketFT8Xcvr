 ...
 *
 **/
void Contact::begin(const char* myStationCall, const char* workedCall, unsigned freq, const char* mode, const char* myRig, unsigned oddEven, const char* mySOTAref) {
    // Sanity checks
