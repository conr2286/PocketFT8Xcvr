...
bool Contact::isValid() {
  return strlen(this->workedCall) > 0 && strlen(this->myCall) > 0 && strlen(this->band) > 0 && strlen(this->mode) > 0 && strlen(this->qsoDate) > 0 && strlen(this->qsoTime) > 0 && strlen(this->band) > 0 && strlen(this->workedRSL) > 0 && strlen(this->myRSL) > 0;
}  //isValid()
