...
class Contact {
   public:
    ...
    void begin(const char* myCall, const char* workedCall, unsigned freq, const char* mode, const char* myRig, unsigned oddEven, const char* mySOTAref);  // Begin a new, active QSO
