...
const char AA0[] = " 0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ+-./?";
const char AA1[] = " 0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
const char AA2[] = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
const char AA3[] = "0123456789";
const char AA4[] = " ABCDEFGHIJKLMNOPQRSTUVWXYZ";
...
int32_t pack28(const char *callsign) {
    ...
    if ((i0 = char_index(AA1, c6[0])) >= 0 && (i1 = char_index(AA2, c6[1])) >= 0 &&
        (i2 = char_index(AA3, c6[2])) >= 0 && (i3 = char_index(AA4, c6[3])) >= 0 &&
        (i4 = char_index(AA4, c6[4])) >= 0 && (i5 = char_index(AA4, c6[5])) >= 0) {
