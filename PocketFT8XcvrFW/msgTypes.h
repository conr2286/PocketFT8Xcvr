...
typedef enum MsgTypeValues {
  ...
  MSG_RR73 = 3,    //Roger report and 73
  MSG_RRSL = 4,    //Roger report and here's your RSL (e.g. AG0E KQ7B R-10)
  MSG_RRR = 5,     //Roger and your RSL (e.g. AG0E KQ7B R-10) message
  MSG_EOT = 6,     //Received end-of-transmission (e.g. RRR, RR73 or 73) message
