...
void TransitionDither::init( HX8357_t3 tft ) {

}

void TransitionDither::restart( HX8357_t3 tft, uint_fast16_t inColor ) {
...
void TransitionDither::perFrame( HX8357_t3 tft, FrameParams frameParams ) {
