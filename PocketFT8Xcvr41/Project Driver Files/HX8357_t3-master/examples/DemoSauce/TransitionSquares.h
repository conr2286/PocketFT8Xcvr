...
void TransitionSquares::init( HX8357_t3 tft ) {

}

void TransitionSquares::restart( HX8357_t3 tft, uint_fast16_t inColor ) {
...
void TransitionSquares::perFrame( HX8357_t3 tft, FrameParams frameParams ) {
