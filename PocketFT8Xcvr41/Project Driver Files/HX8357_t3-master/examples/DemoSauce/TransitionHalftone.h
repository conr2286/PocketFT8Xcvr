...
public:
  ...
  void init( HX8357_t3 tft );
	void restart( HX8357_t3 tft, uint_fast16_t color );
...
void TransitionHalftone::init( HX8357_t3 tft ) {

}

void TransitionHalftone::restart( HX8357_t3 tft, uint_fast16_t inColor ) {
...
void TransitionHalftone::perFrame( HX8357_t3 tft, FrameParams frameParams ) {
