...
#ifndef _HX8357_t3NH_
#define _HX8357_t3NH_
...
#ifdef KINETISK
#define HX8357_SPICLOCK 26000000
#define HX8357_SPICLOCK_READ 2000000
#elif defined(__IMXRT1052__) || defined(__IMXRT1062__)  // Teensy 4.x
#define HX8357_SPICLOCK 26000000u
#define HX8357_SPICLOCK_READ 2000000
#else
#define HX8357_SPICLOCK 26000000
#define HX8357_SPICLOCK_READ 2000000
...
class HX8357_t3n : public Print {
   public:
    HX8357_t3n(uint8_t _CS, uint8_t _DC, uint8_t _RST = 255,
               uint8_t _MOSI = 11, uint8_t _SCLK = 13, uint8_t _MISO = 12);
    void begin(uint32_t spi_clock = HX8357_SPICLOCK, uint32_t spi_clock_read = HX8357_SPICLOCK_READ);
    ...
    // https://github.com/vitormhenrique/HX8357_t3
    ...
    enum { HX8357_DMA_INIT = 0x01,
           HX8357_DMA_CONT = 0x02,
           HX8357_DMA_FINISH = 0x04,
           HX8357_DMA_ACTIVE = 0x80 };
    ...
    boolean asyncUpdateActive(void) { return (_dma_state & HX8357_DMA_ACTIVE); }
    ...
    // Added support to get the leading (text height)
    uint16_t getLeading(void);
   ...
   protected:
    ...
    uint32_t _SPI_CLOCK;       // #define HX8357_SPICLOCK 30000000
    uint32_t _SPI_CLOCK_READ;  // #define HX8357_SPICLOCK_READ 2000000
    ...
    static HX8357_t3n *_dmaActiveDisplay[3];          // Use pointer to this as a way to get back to object...
#else
    static HX8357_t3n *_dmaActiveDisplay;  // Use pointer to this as a way to get back to object...
#endif
...
class HX8357_Button {
   public:
    ...
    void initButton(HX8357_t3n *gfx, int16_t x, int16_t y,
                    uint8_t w, uint8_t h,
