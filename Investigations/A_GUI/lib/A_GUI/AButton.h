 ...
 */
 ...
 class AButton : public AWidget {
    public:
     ...
     // Constructors
     AButton(HX8357_t3n *tft, const char *str, AColor borderColor);    
     AButton(HX8357_t3n *tft, const char *str, ACoord x1, ACoord y1, ACoord w, ACoord h, AColor borderColor);    
